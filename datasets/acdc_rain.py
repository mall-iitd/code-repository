...
class ACDCRainDataset(Cityscapes):
    ...
    def __init__(self, root, split='val', transforms=None):
        ...
        if split == 'val':
            self.imgs_root = os.path.join(root,'rgb_anon_trainvaltest/rgb_anon/rain/val/')
            self.masks_root = os.path.join(root,'gt_trainval/gt/rain/val/')
            ...
            self.imgs_root = os.path.join(root,'rgb_anon_trainvaltest/rgb_anon/rain/test/')
