...
class ACDCFogDataset(Cityscapes):
    ...
    def __init__(self, root, split='val', transforms=None):
        ...
        if split == 'val':
            self.imgs_root = os.path.join(root,'rgb_anon_trainvaltest/rgb_anon/fog/val/')
            self.masks_root = os.path.join(root,'gt_trainval/gt/fog/val/')
            ...
            self.imgs_root = os.path.join(root,'rgb_anon_trainvaltest/rgb_anon/fog/test/')
