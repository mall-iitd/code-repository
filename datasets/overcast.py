...
class overcastDataset(Cityscapes):
    ...
    def __init__(self, root, transforms=None):
        ...
        self.imgs_root = os.path.join(root,'overcast/')
        self.masks_root = os.path.join(root,'overcast/')

        self.imgs = [mask for mask in list(sorted(os.listdir(self.masks_root))) if 'jpg' in mask]
        self.masks = [mask for mask in list(sorted(os.listdir(self.masks_root))) if '_train_id' in mask]
        print(len(self.imgs))
