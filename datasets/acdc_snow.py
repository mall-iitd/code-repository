...
class ACDCSnowDataset(Cityscapes):
    ...
    def __init__(self, root, split='val', transforms=None):
        ...
        if split == 'val':
            self.imgs_root = os.path.join(root,'rgb_anon_trainvaltest/rgb_anon/snow/val/')
            self.masks_root = os.path.join(root,'gt_trainval/gt/snow/val/')
            ...
            self.imgs_root = os.path.join(root,'rgb_anon_trainvaltest/rgb_anon/snow/test/')
